...
//       <p>Employee Code : FT00${product.id}</p>
//       <p>Name : ${product.name}</p>
//       <p>Price : ${product.price}</p>
//       <p>Quantity : ${product.quantity}</p>
//       // <p>Branch : ${product.branch.id}</p>
      ...
      for (const p of products) {
        ...
        str += `<tr>
                        <td>${p.name}</td>
                         ...
                         <a type="button" class="btn btn-warning" onclick="showEdit(${p.id})" data-toggle="modal" data-target="#myModal">Edit</a>
